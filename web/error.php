        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                ...
                <td valign="top" class="content">
                    <!-- -->
                    <h3>Вы уже использовали тестовый аккаунт</h3>
                    ...
                    <div class="pay">
                        ...
                        <form action="http://test.foxweb.com.ua/dreamnet/qiwi_proccess.php" method="get" accept-charset="windows-1251" onsubmit="return checkSubmit()">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <th>Номер Вашего мобильного телефона</th>

                                    <td>
                                        <!-- Маска для ввода номера телефона, Вы можете заменить это поле на обычный input с именем 'to'
                                        и не использовать javascript, в этом случае уберите атрибут onsubmit у формы -->
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function checkSubmit() {
                                                ...
                                                if (from==null || prefix==null) {
                                                    alert("Не выбран неселенный пункт");
                                                    return false;
                                                }
                                                else
                                                ...
                                                if (inputMasks["idto"].getValue().match(/^\d{10}$/)) {
                                                    ...
                                                    alert("Введите номер телефона в федеральном формате и без \"8\" и без \"+7\"");
                                                    return false;
                                                }
                                            }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id="tarif" onChange="setSumm(this)">
                                            <option value=""></option>
                                            <option value="50">Тик-Так</option>
                                            <option value="100">Сутки</option>
                                            <option value="500">Абонемент</option>
                                            <option value="800">Абонемент плюс</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td><input type="text" id="amount_rub" style="width: 95px" name="amount_rub"> руб. <input type="text" id="amount_kop" name="amount_kop" maxlength="2" size="2">
                                        коп.
                                    </td>
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <input type="submit" class="button" value="Выставить счет">
